...
class AddressController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('addresses.create')->with('success', __('messages.address_added_successfully'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('success', __('messages.address_updated_successfully'));
    }
